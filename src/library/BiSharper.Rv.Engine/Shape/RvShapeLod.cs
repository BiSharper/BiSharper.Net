...
using System.Text;
using BiSharper.Rv.Render.Shape.Types;
using BiSharper.Rv.Render.Shape.Utils;
using BiSharper.Rv.Shape.Flags;

namespace BiSharper.Rv.Render.Shape;

public class RvShapeLod
{
    ...
    private void CalculateMinMaxes()
    {
        ...
        for (var i = 0; i < 2; i++)
        {
            ...
            if (!(maxXY[i] - minXY[i] < minIntervalSize)) continue;
